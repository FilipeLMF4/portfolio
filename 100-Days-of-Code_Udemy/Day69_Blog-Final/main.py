...
def register():
    ...
    if new_user_form.validate_on_submit():
        ...
        hashed_pass = generate_password_hash(new_user_form.password.data, method="pbkdf2:sha256", salt_length=6)
        new_user = User(
...
def login():
    ...
    if login_form.validate_on_submit():
        ...
        if user:
            ...
            flash("That email does not exist. Please register to continue.")
